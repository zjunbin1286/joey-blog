...
![image1.png](../../../../assets/interview/07-node-stream/image1.png)
...
### 1. 双工流
比如说`websocket`通信，是一个全双工通信，发送方和接受方都是各自独立的方法，发送和接收都没有任何关系

如下图所示：

![image2.png](../../../../assets/interview/07-node-stream/image2.png)
...
![image3.png](../../../../assets/interview/07-node-stream/image3.png)
