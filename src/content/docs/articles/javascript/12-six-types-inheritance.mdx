...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cb91633be9244ecaa7b3e5a782c90fe8~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3b547ca477dd4d47bad3589e33dde351~tplv-k3u1fbpfcp-watermark.image?)
...
## 7. 写到最后
到此为止，关于 JavaScript 中实现继承的六种方法就全部总结完毕了，如果你能坚持看到这里，相信继承这一块的知识你已经足够掌握了。当然，JS 还有其他相当重要的知识点，比如 this 指向等等，可以点击 [一篇文章带你搞懂 this 的四个绑定规则 ✍](https://juejin.cn/post/7132032582832635934) 前往学习。
